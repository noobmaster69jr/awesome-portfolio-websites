...
const exp = [
  {
    ...
    cardImage: "assets/images/experience-page/skillvertex.png",
    place: "Flipkart",
    time: "(Oct - Nov, 2021)",
    desp: "<li>Worked with Artifintel in association with Skillvertex </li> <li>Made changes in the  progressive web page of a Ecommerce site for Electronic goods.</li>",
  },
  // {
